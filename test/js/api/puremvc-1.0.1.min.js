 ...
 * returns registered Proxy and Mediator on onRegister
 * added queryString (@object) to Facade
 */
...
this.url=null;this.queryString={};var query=window.location.search.substring(1);var vars=query.split("&");for(var i=0;i<vars.length;i++){var pair=vars[i].split("=");if(typeof this.queryString[pair[0]]==="undefined"){this.queryString[pair[0]]=pair[1]}else if(typeof this.queryString[pair[0]]==="string"){var arr=[this.queryString[pair[0]],pair[1]];this.queryString[pair[0]]=arr}else{this.queryString[pair[0]].push(pair[1])}}
}
function c(a){if(null!=c.instanceMap[a])throw Error(c.MULTITON_MSG);this.multitonKey=a;c.instanceMap[this.multitonKey]=this;this.mediatorMap=[];this.observerMap=[];this.initializeView()}function e(a){if(e.instanceMap[a])throw Error(e.MULTITON_MSG);this.multitonKey=a;e.instanceMap[a]=this;this.proxyMap=[];this.initializeModel()}function f(a){if(null!=f.instanceMap[a])throw Error(f.MULTITON_MSG);this.multitonKey=a;f.instanceMap[this.multitonKey]=this;this.commandMap=[];this.initializeController()}
...
function(a){return this.model.registerProxy(a);};b.prototype.retrieveProxy=function(a){return this.model.retrieveProxy(a)};b.prototype.removeProxy=function(a){var d=null;null!=this.model&&(d=this.model.removeProxy(a));return d};b.prototype.hasProxy=function(a){return this.model.hasProxy(a)};b.prototype.registerMediator=function(a){if(null != this.view) return this.view.registerMediator(a);};b.prototype.retrieveMediator=function(a){return this.view.retrieveMediator(a)};b.prototype.removeMediator=function(a){var d=null;
